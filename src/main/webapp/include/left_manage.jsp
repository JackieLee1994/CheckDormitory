...
<div class="span3">
	...
	<div class="account-container">
		...
		<div class="account-details">
			...
			<span class="account-name">${sessionScope.username }</span> <span
				class="account-role">${sessionScope.type }</span> <span
				class="account-actions"> <a href="javascript:;">个人中心</a> | <a
				href="javascript:;">系统设置</a>
			</span>
	...
	<ul id="main-nav" class="nav nav-tabs nav-stacked">
		<li><a href="${pageContext.request.contextPath}"> <i
				class="icon-signal"></i> 维修报表统计
		</a></li>
		<li><a href="${pageContext.request.contextPath}"> <i
				class="icon-home"></i> 报修情况
		</a></li>

		<li><a href="${pageContext.request.contextPath}"> <i
				class="icon-th-list"></i>投诉情况
		</a></li>
