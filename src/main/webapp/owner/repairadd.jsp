									...
									<div class="tabbable">
										...
										<div class="tab-content">
											<div class="tab-pane active" id="1">
												<form id="edit-profile" class="form-horizontal"  action="${pageContext.request.contextPath}/repairtask/add"
													method="post" />
												<fieldset>
													...
													<div class="control-group">
														...
														<div class="controls">
															<select class="input-medium " id="parentproject"
																name="parentproject" onclick="getProject('parentproject','project')">
													...
													<div class="control-group">
														...
														<div class="controls">
															<select class="input-medium " id="parentmaintain"
																name="parentmaintain"  onclick="getMaintain('parentmaintain','maintain')" >
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" class="input-large" id="content"  name="content"
																placeholder="维修内容" />
														</div>
														<!-- /controls -->
													</div>
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" class="input-large" id="adress"  name="adress"
																placeholder="维修详细地址" />
														</div>
														<!-- /controls -->
													</div>
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" class="input-medium" id="tel"  name="tel"
																placeholder="客户联系电话" />
														</div>
														<!-- /controls -->
													</div>
