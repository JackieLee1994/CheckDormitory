...
<script type="text/javascript">
	...
	$("#type option:contains('${user.type}')").attr("selected",
			true);
	
	var  gender="${user.gender}";
	if (gender == 0) {
		$("#gender option:contains('男')").attr("selected",
				true);
	} else if (gender == 1) {
		$("#gender option:contains('女')").attr("selected",
				true);
	}
	});
</script>
...
<body>
	...
	<div id="content">
		<div class="container">
			<div class="row">
				<%@ include file="/include/left_manage.jsp"%>
				<div class="span9">
