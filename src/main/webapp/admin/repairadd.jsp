										...
										<div class="tab-content">
											<div class="tab-pane active" id="1">
												<form id="edit-profile" class="form-horizontal"
													action="${pageContext.request.contextPath}/repairtask/adminadd"
													method="post" />
												<fieldset>
													...
													<div class="control-group">
														<label class="control-label" for="lastname">报修人</label>
														<div class="controls">
															<input type="text" class="input-large" id="repairpeople"
																name="repairpeople" placeholder="报修人" />
														</div>
														<!-- /controls -->
													</div>
													<!-- /control-group -->
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" class="input-large" id="adress"
																name="adress" placeholder="维修详细地址" />
														</div>
														<!-- /controls -->
													</div>
													<!-- /control-group -->
