...
$(document).ready(function() {
	alert("${repairTask.repairproject}");
	$("#project option[text='${repairTask.repairproject}']").attr("selected", true);   //设置Select的Text值为jQuery的项选中
	/* $("#project option:contains('${repairTask.repairproject}')").attr("selected",
			true);
	$("#maintain option:contains('${repairTask.repairtype}')").attr("selected",
			true); */
	});
</script>
													...
													<div class="control-group">
														...
														<div class="controls">
															<select class="input-medium " id="parentmaintain"
																name="parentmaintain"
																onclick="getMaintain('parentmaintain','maintain')">
