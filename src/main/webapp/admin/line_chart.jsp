...
<head>
    ...
    <link href="${pageContext.request.contextPath}/datepicker/less/datepicker.less" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/datepicker/css/datepicker.css" rel="stylesheet">
